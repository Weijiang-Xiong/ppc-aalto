...
std::ostream &operator<<(std::ostream &out, const ppc::timer &timer) {
...
template <typename T>
static void print_matrix(int ny, int nx, T *data, std::unique_ptr<ppc::fdostream> &stream) {
    *stream << "[";
