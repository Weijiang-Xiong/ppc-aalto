...
MIN_GCC, MAX_GCC = 5, 15
MIN_CLANG, MAX_CLANG = 4, 20
...
class Compiler:
    ...
    def add_omp_flags(self) -> 'Compiler':
        ...
        if isinstance(self, ClangCompiler) and platform.system() == 'Darwin':
            try:
            ...
            if output.returncode == 0:
                ...
                if '__clang__' not in macros and '_OPENMP' in macros:
                    ...
                    try:
                        ...
                        if best is None or best[1] < version:
        ...
        try:
            ...
            if output.returncode == 0:
                ...
                if '__clang__' in macros and '_OPENMP' in macros:
                    try:
                        version = (int(macros['__clang_major__']),
                                   int(macros['__clang_minor__']),
                                   int(macros['__clang_patchlevel__']))
                        if best is None or best[1] < version:
                            best = (program, version)
                    except TypeError:
                        pass
