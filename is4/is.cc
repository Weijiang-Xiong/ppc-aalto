...
Result segment(int ny, int nx, const float *data) {
    ...
    {   
        ...
        double window_best{HUGE_NEGATIVE}; // the window size of the best loss in this thread
    ...
    inv_in = static_cast<double>(1) / numel_in;
    inv_out = static_cast<double>(1) / numel_out;
